...
var OGSUS = (function (main) {
	...
	function load_game_core () {
		...
		main.asset_require( assetsGameCore, [ init_setup, load_game_extras ], true );
    ...
    function init_setup ( sc, cc, w, uiq, mh ) {
		...
		main.world = new _World.Instance();
		main.world.show();
