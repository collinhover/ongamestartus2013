...
TWEEN.Tween = function ( object ) {
	...
	this.getTarget = function() { return _valuesEnd; };
	...
	this.start = function ( time ) {
		...
		if ( typeof _onStartCallback === 'function' ) {
	...
	this.stop = function () {
		...
		if ( typeof _onStopCallback === 'function' ) {
	...
	this.update = function ( time ) {
		...
		if ( typeof _onUpdateCallback === 'function' ) {
